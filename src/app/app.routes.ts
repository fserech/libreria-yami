...
// Rutas corregidas para el módulo de purchases
{
  path: 'purchases',
  title: 'Compras',
  // loadComponent: () => import('./dashboard/pages/clients/clients.component'),
...
},
{
        ...
        children: [
          ...
          },
          {
            ...
            title: 'Sucursales',
            canMatch: [authGuard],
            loadComponent: () => import('./dashboard/pages/branches/branches-grid-main/branches-grid-main.component'),
          },
          {
            path: 'detail/:mode',
            title: 'sucursales',
            canMatch: [authGuard],
            canDeactivate: [pendingChangesGuard],
            loadComponent: () => import('./dashboard/pages/branches/branch-form/branch-form.component'),
          },
          {
            path: 'detail/:mode/:id',
            title: 'Sucursales',
