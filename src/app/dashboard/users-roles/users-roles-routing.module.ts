...
import { TransactionTypesUnloadResolver } from './resolvers/roles.resolver';

const routes: Routes = [
  {path: '',component: NewRolComponent },
  {path: 'new-rol',component: NewRolComponent },
  {path: 'new-user',component: NewUserComponent, resolve: { data: TransactionTypesUnloadResolver } },
