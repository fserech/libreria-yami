...
import { matArrowBackOutline, matEmailOutline, matLocationOnOutline, matPhoneEnabledOutline, matPhoneOutline } from '@ng-icons/material-icons/outline';
...
@Component({
  ...
  viewProviders: [provideIcons({ matArrowBackOutline, matPhoneEnabledOutline,
    matEmailOutline,      // ← AGREGAR
    matPhoneOutline,      // ← AGREGAR
